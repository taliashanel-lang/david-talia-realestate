          ...
          <div className="mx-auto grid max-w-6xl gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {listings.map((listing, i) => (
              <FadeIn key={listing.id} delay={(i % 3) * 80}>
                <div className="overflow-hidden rounded-2xl border border-black/10 bg-white shadow-sm transition-all duration-300 hover:-translate-y-1.5 hover:shadow-xl">
                  ...
                  <div className="p-5">
                    <h3 className="mb-1 text-lg font-bold text-brand-black">{listing.title}</h3>
